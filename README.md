...
- [Support Verion](#Support-Version)
- [Install](#Install)
- [Usage](#Usage)
- [Error](#Error)
...
## build libfuzzer
cd compiler-rt/lib/fuzzer && ./move.py -m small
cd ../../ && mkdir -p build && cd build
cmake .. && make && make install

## build forkserver tools
export LLVM_HOME=${INSTALL_LLVM}/llvm-project
cd ../lib/fuzzer/small_forkserver/ && make all
...
```
 ...
 ## /${INSTALL_LLVM}/llvm-project/compiler-rt/lib/fuzzer/small_forkserver/bin/parent
